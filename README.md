...
Course Project is placed in this repo. It includes: script file **run_analysis.R**, tidy data file **Data_set_mean.txt**, **README.md**, **Code_book.md** and variables description **Data_set_mean.txt**.    
